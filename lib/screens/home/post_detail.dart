...
class HomePostDetail extends StatefulWidget {
  @override
  State<HomePostDetail> createState() => _HomePostDetailState();
}

class _HomePostDetailState extends State<HomePostDetail> {
            ...
            Column(
              ...
              children: [
                  ...
                  children: [
                    Flexible(
                      child: Padding(
                        ...
                        child: Text(
                          feedController.feeds?[index].title ?? "제목",
                          style: TextStyle(
                              fontFamily: "AppleSDGothicNeo",
                              fontSize: 18,
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 8.0, left: 20, right: 20),
                  child: Text(
                    feedController.feeds?[index].content ?? "내용\n\n\n\n내용",
                    style: TextStyle(
                      fontFamily: "AppleSDGothicNeo",
                      fontSize: 14,
                    ),
    ...
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int picIndex) {
        return Column(
          ...
          children: [
            // feedController.feeds?[index].attachments?[picIndex].fileInfo
            //             .smallUrl !=
            //         null
            //     ?
            Container(
                    child: CachedNetworkImage(
                      fit: BoxFit.cover,
                      imageUrl: isImage(feedController.feeds![index]
