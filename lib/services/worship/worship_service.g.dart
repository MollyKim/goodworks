...
class _WorshipService implements WorshipService {
  ...
  Future<WorshipTypeList> getWorshipTypeList(
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<WorshipTypeList>(Options(
      method: 'GET',
  ...
  Future<WorshipTypeCreate> postWorshipTypeCreate(
    ...
    _data.addAll(body);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<WorshipTypeCreate>(Options(
      method: 'POST',
      headers: <String, dynamic>{
        r'Country': 'KR',
        r'Authorization': token,
  ...
  Future<WorshipTypeUpdate> putWorshipTypeUpdate(
    ...
    _data.addAll(body);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<WorshipTypeUpdate>(Options(
      method: 'PUT',
      headers: <String, dynamic>{
        r'Country': 'KR',
        r'Authorization': token,
  ...
  Future<WorshipTypePriorityUpdate> putWorshipTypePriorityUpdate(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/church/$churchId/worship-type/priority',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<WorshipTypeDelete> deleteWorshipTypeDelete(
    ...
    _data.addAll(body);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<WorshipTypeDelete>(Options(
      method: 'DELETE',
      headers: <String, dynamic>{
        r'Country': 'KR',
        r'Authorization': token,
  ...
  Future<WorshipList> getWorshipList(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<WorshipList>(Options(
      method: 'GET',
      headers: <String, dynamic>{
        r'Country': 'KR',
        r'Authorization': token,
  ...
  Future<WorshipDetail> getWorshipDetail(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<WorshipDetail>(Options(
      method: 'GET',
      headers: <String, dynamic>{
        r'Country': 'KR',
        r'Authorization': token,
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/church/$churchId/worship/$worshipId',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<WorshipCreate> postWorshipCreate(
    ...
    _data.addAll(body);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<WorshipCreate>(Options(
      method: 'POST',
      headers: <String, dynamic>{
        r'Country': 'KR',
        r'Authorization': token,
  ...
  Future<WorshipUpdate> putWorshipUpdate(
    ...
    _data.addAll(body);
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<WorshipUpdate>(Options(
      method: 'PUT',
      headers: <String, dynamic>{
        r'Country': 'KR',
        r'Authorization': token,
  ...
  Future<WorshipDelete> deleteWorshipDelete(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<WorshipDelete>(Options(
      method: 'DELETE',
      headers: <String, dynamic>{
        r'Country': 'KR',
        r'Authorization': token,
